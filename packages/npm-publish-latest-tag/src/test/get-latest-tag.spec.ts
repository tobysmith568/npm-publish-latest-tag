import { getLatestTag } from "../lib/get-latest-tag";
import { getLatestVersion } from "../lib/utils/npm-package";
import { getPackageJson } from "../lib/utils/package-json";

jest.mock("../lib/utils/package-json");
jest.mock("../lib/utils/npm-package");
